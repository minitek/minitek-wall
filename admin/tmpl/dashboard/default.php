...
$moduleIsInstalled = MinitekWallHelper::checkModuleIsInstalled();
?>
	...
	<?php if (!$moduleIsInstalled) { ?>
		<div class="alert alert-danger text-center mt-0">
			<div class="update-info">
				<div>
					<b><?php echo Text::_('COM_MINITEKWALL_DASHBOARD_WARNING'); ?></b>
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-8">
			<div class="media mt-0">
			    ...
			    <h2 class="media-heading"><?php echo Text::_('COM_MINITEKWALL'); ?> <span class="badge badge-success">Free</span></h2>
