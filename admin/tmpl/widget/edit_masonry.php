...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_layout" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_layout'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_image_settings" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_image_settings'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_detailbox_general" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_detailbox_general'); ?></div>
		</fieldset>
	</div>
</div>
<br>
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_detailbox_big" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_detailbox_big'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_detailbox_landscape" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_detailbox_landscape'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_detailbox_portrait" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_detailbox_portrait'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_detailbox_small" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_detailbox_small'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_detailbox_column" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_detailbox_column'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_hoverbox" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_hoverbox'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_pagination" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_pagination'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_filters" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_filters'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_effects" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_effects'); ?></div>
		</fieldset>
	</div>
</div>
<?php
...
<div class="row">
	<div class="col-12">
		<fieldset id="fieldset-masonry_responsive_settings" class="options-grid-form options-grid-form-full">
			<div><?php echo $this->masonryform->renderFieldset('masonry_responsive_settings'); ?></div>
		</fieldset>
	</div>
</div>
<?php
