...
if ($this->params->get('mas_category_filters')) {
	...
	if ($cat_array && $this->params->get('mas_filter_type', 1) == '1') { ?>
		<div class="mwall-filters-group button-group button-group-category mwall-buttons" data-filter-group="category">
			<?php if ($this->params->get('mas_category_filters_label', 'FILTER_BY_CATEGORY')) { ?>
				<span><?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_category_filters_label', 'FILTER_BY_CATEGORY')); ?></span>
			<?php } ?>
			<ul>
				<li>
					<a href="#" data-id="0" data-filter="" class="mwall-filter mwall-filter-active">
						<?php echo Text::_('COM_MINITEKWALL_SHOW_ALL'); ?>
					</a>
				</li>
				<?php
				foreach ($cat_array as $key => $category) {
					...
					<li>
						<a href="#" data-id="<?php echo $key; ?>" data-filter=".cat-<?php echo $class; ?>" class="mwall-filter">
							<?php echo $title; ?></a>
					</li>
				<?php } ?>
			</ul>
		...
		<div class="mwall-filters-group">
			<div class="mwall-dropdown">
				<div class="dropdown-label cat-label">
					<span data-label="<?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_category_filters_label', 'FILTER_BY_CATEGORY')); ?>">
						<i class="fa fa-angle-down"></i>
						<span>
							<?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_category_filters_label', 'FILTER_BY_CATEGORY')); ?>
						</span>
					</span>
				</div>
...
if ($this->params->get('mas_tag_filters', 1)) {
	...
	if ($tag_array && $this->params->get('mas_filter_type', 1) == '1') { ?>
		<div class="mwall-filters-group button-group button-group-tag mwall-buttons" data-filter-group="tag">
			<?php if ($this->params->get('mas_tag_filters_label', 'FILTER_BY_TAG')) { ?>
				<span><?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_tag_filters_label', 'FILTER_BY_TAG')); ?></span>
			<?php } ?>
			<ul>
				<li>
					<a href="#" data-id="0" data-filter="" class="mwall-filter mwall-filter-active">
				...
				<?php foreach ($tag_array as $key => $tag) {
					...
					<li>
						<a href="#" data-id="<?php echo $key; ?>" data-filter=".tag-<?php echo $class; ?>" class="mwall-filter">
							<?php echo $title; ?>
						</a>
					</li>
				<?php } ?>
		...
		<div class="mwall-filters-group">
			<div class="mwall-dropdown">
				<div class="dropdown-label tag-label">
					<span data-label="<?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_tag_filters_label', 'FILTER_BY_TAG')); ?>">
						<i class="fa fa-angle-down"></i>
						<span>
							<?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_tag_filters_label', 'FILTER_BY_TAG')); ?>
						</span>
					</span>
				</div>
...
if ($this->params->get('mas_date_filters', 0)) {
	...
	foreach ($this->wall as $key => $item) {
		if (isset($item->itemDateRaw) && $item->itemDateRaw)
			array_push($date_array, HTMLHelper::_('date', $item->itemDateRaw, 'Y-m'));
	}
	...
	if ($date_array && $this->params->get('mas_filter_type', 1) == '1') { ?>
		<div class="mwall-filters-group button-group button-group-date mwall-buttons" data-filter-group="date">
			<?php if ($this->params->get('mas_date_filters_label', 'FILTER_BY_DATE')) { ?>
				<span><?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_date_filters_label', 'FILTER_BY_DATE')); ?></span>
			<?php } ?>
			<ul>
				<li>
					<a href="#" data-id="0" data-filter="" class="mwall-filter mwall-filter-active">
				...
				<?php foreach ($date_array as $date) {
					...
					$date = HTMLHelper::_('date', $date, 'M Y'); ?>
					<li>
						<a href="#" data-id="<?php echo $class; ?>" data-filter=".date-<?php echo $class; ?>" class="mwall-filter">
							<?php echo $date; ?>
						</a>
					</li>
				<?php } ?>
		...
		<div class="mwall-filters-group">
			<div class="mwall-dropdown">
				<div class="dropdown-label date-label">
					<span data-label="<?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_date_filters_label', 'FILTER_BY_DATE')); ?>">
						<i class="fa fa-angle-down"></i><span>
							<?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_date_filters_label', 'FILTER_BY_DATE')); ?>
						</span>
					</span>
				</div>
