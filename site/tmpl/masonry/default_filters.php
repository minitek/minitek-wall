...
?><div class="mwall-filters-group button-group button-group-category mwall-buttons" data-filter-group="category"><?php
																													...
																													?><span><?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_category_filters_label', 'FILTER_BY_CATEGORY')); ?></span><?php
																																																													}

																																																														?><ul>
				<li>
					<a href="#" data-id="0" data-filter="" class="mwall-filter mwall-filter-active"><?php
																									echo Text::_('COM_MINITEKWALL_SHOW_ALL');
																									?></a>
				</li><?php
				...
				<div class="dropdown-label cat-label">
					<span data-label="<?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_category_filters_label', 'FILTER_BY_CATEGORY')); ?>">
						<i class="fa fa-angle-down"></i><span><?php
																echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_category_filters_label', 'FILTER_BY_CATEGORY'));
																?></span>
					</span>
				</div>
		...
		if ($this->params->get('mas_tag_filters', 1)) {
			...
			if ($tag_array && $this->params->get('mas_filter_type', 1) == '1') {
				?><div class="mwall-filters-group button-group button-group-tag mwall-buttons" data-filter-group="tag"><?php
																														...
																														?><span><?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_tag_filters_label', 'FILTER_BY_TAG')); ?></span><?php
																																																											}
			...
			<div class="mwall-dropdown">
				<div class="dropdown-label tag-label">
					<span data-label="<?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_tag_filters_label', 'FILTER_BY_TAG')); ?>">
						<i class="fa fa-angle-down"></i><span><?php
																echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_tag_filters_label', 'FILTER_BY_TAG'));
																?></span>
					</span>
				</div>
		...
		if ($this->params->get('mas_date_filters', 0)) {
			...
			if ($date_array && $this->params->get('mas_filter_type', 1) == '1') {
				?><div class="mwall-filters-group button-group button-group-date mwall-buttons" data-filter-group="date"><?php
																															...
																															?><span><?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_date_filters_label', 'FILTER_BY_DATE')); ?></span><?php
																																																													}
			...
			<div class="mwall-dropdown">
				<div class="dropdown-label date-label">
					<span data-label="<?php echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_date_filters_label', 'FILTER_BY_DATE')); ?>">
						<i class="fa fa-angle-down"></i><span><?php
																echo Text::_('COM_MINITEKWALL_' . $this->params->get('mas_date_filters_label', 'FILTER_BY_DATE'));
																?></span>
					</span>
				</div>
