...
if (!empty($this->wall) ||  $this->wall!== 0)
{
	...
	foreach ($this->wall as $key=>$item)
	{
		...
		<div
			...
			<?php } ?>
			<?php if (isset($item->itemRating)) { ?>
				data-rating="<?php echo $item->itemRating; ?>"
			<?php } ?>
			<?php if (isset($item->itemComments)) { ?>
				data-comments="<?php echo $item->itemComments; ?>"
			<?php } ?>
			<?php if (isset($item->itemSales)) { ?>
				data-sales="<?php echo $item->itemSales; ?>"
			<?php } ?>
			<?php if (isset($item->itemPoints)) { ?>
				data-points="<?php echo $item->itemPoints; ?>"
			<?php } ?>
			<?php if (isset($item->itemFriends)) { ?>
				data-friends="<?php echo $item->itemFriends; ?>"
			<?php } ?>
			<?php if (isset($item->itemMembers)) { ?>
				data-members="<?php echo $item->itemMembers; ?>"
			<?php } ?>
			<?php if (isset($item->itemConfirmed)) { ?>
				data-confirmed="<?php echo $item->itemConfirmed; ?>"
			<?php } ?>
			<?php if (isset($item->itemTickets)) { ?>
				data-tickets="<?php echo $item->itemTickets; ?>"
			<?php } ?>
			<?php if (isset($item->rawIndex)) { ?>
				data-index="<?php echo $item->rawIndex; ?>"
			<?php } ?>
		>
			...
			>
				...
				<div
					...
					style="
					<?php if ($options['position_class'] == 'content-below' || (!isset($item->itemImage) || !$item->itemImage || !$this->mas_images)) { ?>
				...
				>
						...
						<div class="mnwall-cover <?php echo $this->hoverEffectClass; ?>">
							...
							<div
								...
								style="
									...
									<?php if ($options['position_class'] != 'content-below') { ?>
										<?php if ($this->mas_border_radius) { ?>
											border-radius: <?php echo $this->mas_border_radius; ?>px;
										<?php } ?>
										<?php if ($this->mas_border) { ?>
							...
							>
								...
								<?php if ($options['position_class'] != 'content-below' && $this->detailBoxAll) { ?>
					...
					<?php if (($options['position_class'] == 'content-below' || (!isset($item->itemImage) || !$item->itemImage || !$this->mas_images)) && $this->detailBoxAll) { ?>
