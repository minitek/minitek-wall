	...
	?><div class="mwall-date"><?php
		...
		?><div class="mwall-item-info"><?php
								...
								?><p class="mwall-item-category">
											<span><?php echo Text::sprintf('COM_MINITEKWALL_IN_CATEGORIES', $item->itemCategory); ?> </span><?php
																																			?>
										</p><?php
																																			}
											...
											<span><?php echo Text::sprintf('COM_MINITEKWALL_BY_AUTHOR', $item->itemAuthor); ?> </span><?php
																																		?>
										</p><?php
																																			}
