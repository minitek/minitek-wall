		...
		<ul><?php
			...
			?><li>
					...
					<a href="#" data-sort-value="<?php echo $date_sort_value; ?>" class="mwall-filter <?php echo $date_sort_active; ?>"><?php
																																		echo Text::_('COM_MINITEKWALL_DATE');
																																		?></a>
				</li><?php
					}
					...
					<a href="#" data-sort-value="hits" class="mwall-filter <?php echo $hits_sort_active; ?>"><?php
																												echo Text::_('COM_MINITEKWALL_HITS_SORTING');
																												?></a>
				</li><?php
					}
			...
			if ($this->params->get('mas_sorting_direction', 0)) {
				// Inline Direction
			...
			<div class="dropdown-label sorting-label">
				<span data-label="<?php echo Text::_('COM_MINITEKWALL_SORT_BY'); ?>">
					<i class="fa fa-angle-down"></i><span><?php
															echo Text::_('COM_MINITEKWALL_SORT_BY');
															?></span>
				</span>
			</div>
			...
			<div class="mwall-dropdown">
				<div class="dropdown-label sorting-label">
					<span data-label="<?php echo Text::_('COM_MINITEKWALL_SORT_DIRECTION'); ?>">
						<i class="fa fa-angle-down"></i><span><?php
																echo Text::_('COM_MINITEKWALL_SORT_DIRECTION');
																?></span>
					</span>
				</div>
