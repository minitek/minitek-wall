    ...
    class Mwall 
    {
        ...
        */
        ...
        initializeWall()
        {
            ...
            this.sortDirection = (this.container.getAttribute('data-direction') == null) ? '' : this.container.getAttribute('data-direction').toLowerCase();
            this.sortAscending = (this.sortDirection == 'asc') ? true : false;
            
            if (this.sortBy == 'RAND()' || this.sortBy == 'rand' || this.sortBy == 'random')
			{
				this.sortBy = ['index'];
				this.sortAscending = true;
			}
			else
				this.sortBy = [this.sortBy, 'id', 'title'];
        ...
        filtersSortings()
        {
            ...
            {
                self.container.querySelector('.mnwall_iso_filters_cont').addEventListener('click', function(e)
                {
                    e.preventDefault();
                        ...
                        if (_this.closest('.mnwall_iso_dropdown'))
                        {
                            ...
                            if (typeof data_filter_attr !== typeof undefined && data_filter_attr !== false)
                            {
                                ...
                                if (data_filter_attr.length)
                                    ...
                                    filter_text = _this.closest('.mnwall_iso_dropdown').querySelector('.dropdown-label span').getAttribute('data-label');
            ...
            {
                self.container.querySelectorAll('.button-group').forEach(function(buttonGroup)
                {
            ...
            {
                self.container.querySelector('.mnwall_iso_filters_cont').querySelectorAll('.mnwall_iso_dropdown').forEach(function(dropdownGroup)
                {
                    dropdownGroup.querySelector('.dropdown-label').addEventListener('click', function(e)
                    {
                        ...
                        self.container.querySelectorAll('.mnwall_iso_dropdown').forEach(function(a)
                        {
                ...
                document.addEventListener('mouseup', function(e)
                {
                    ...
                    var dropdowncontainers = self.container.querySelectorAll('.mnwall_iso_dropdown');
            ...
            {
                self.container.querySelector('.sorting-group-filters').querySelectorAll('.mnwall-filter').forEach(function(a) 
                {
                    a.addEventListener('click', function(e)
                    {
                        e.preventDefault();
                        ...
                        if (this.closest('.mnwall_iso_dropdown'))
                        {
                            ...
                            this.closest('.mnwall_iso_dropdown').querySelector('.dropdown-label span span').textContent = sorting_text;
                        }
                        ...
                        self.container.querySelector('.sorting-group-filters').querySelector('.mnw_filter_active').classList.remove('mnw_filter_active');
            ...
            {
                self.container.querySelector('.sorting-group-direction').querySelectorAll('.mnwall-filter').forEach(function(a)
                {
                    a.addEventListener('click', function(e)
                    {
                        e.preventDefault();
                        ...
                        self.container.querySelector('.sorting-group-direction').querySelector('.mnw_filter_active').classList.remove('mnw_filter_active');
                        this.classList.add('mnw_filter_active');
                    });
                });
            }
            ...
            var dropdownSortings = function dropdownSortings()
            {
                ...
                {
                    self.container.querySelector('.mnwall_iso_sortings').querySelectorAll('.mnwall_iso_dropdown').forEach(function(dropdownSorting)
                    {
            ...
            this.resetFilters = function resetFilters()
            {
                ...
                self.container.querySelectorAll('.mnwall_iso_dropdown').forEach(function(dropdownGroup)
                {
                ...
                self.container.querySelectorAll('.sorting-group-filters').forEach(function(sortingGroup)
                {
                    sortingGroup.querySelector('.mnw_filter_active').classList.remove('mnw_filter_active');
                    sortingGroup.querySelector('li a[data-sort-value="' + self.sortBy[0] + '"]').classList.add('mnw_filter_active');
                });

                self.container.querySelectorAll('.sorting-group-direction').forEach(function(sortingGroupDirection)
                {
                    sortingGroupDirection.querySelector('.mnw_filter_active').classList.remove('mnw_filter_active');
                    sortingGroupDirection.querySelector('li a[data-sort-value="' + self.sortDirection + '"]').classList.add('mnw_filter_active');
                });
            ...
            document.querySelectorAll('#mnwall_reset_' + this.widgetId + ', #mnwall_container_' + this.widgetId + ' .mnwall-reset-btn').forEach(function(a)
            {
                a.addEventListener('click', function(e)
                {
                    e.preventDefault();
        ...
        fixEqualHeights(items)
        {
            ...
            if (this.gridType == 98 && this.layoutMode == 'fitRows' && this.dbPosition == 'below' && this.equalHeight)
            {
                var max_height = 0;

                if (items == 'all')
                {
                    this.container.querySelectorAll('.mnwall-item-inner').forEach(function(a)
                    {
                        a.style.height = 'auto';
